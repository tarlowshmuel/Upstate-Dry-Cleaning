          ...
          <CardContent className="p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                { num: "6", label: "Pickup route", desc: "Pick day + wave, then walk it stop-by-stop with notes & status updates" },
                ...
                { num: "12", label: "Delivery route", desc: "Pick day + wave, then walk it stop-by-stop with status updates" },
